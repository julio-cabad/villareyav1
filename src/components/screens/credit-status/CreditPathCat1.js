...
import {
    resource_1, resource_10, resource_13, resource_14, resource_15, resource_16,
    resource_2,
    resource_3,
    resource_4,
    resource_5,
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View style={styles.bodyContainer}>
                <View style={styles.statusContainer}>
                    <View style={styles.iconContainer}>
                        <RouteState icon={resource_16} number={12} text={'Desembolso en cuentas'}
                    ...
                    <View style={styles.iconContainer}>
                        <RouteState icon={resource_15} number={11} color={creditStep === '75' ? 'green' : colors.appColor}
